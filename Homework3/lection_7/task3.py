...
class PublicTransport:
    """
    Класс PublicTransport представляет общественный транспорт.

    Атрибуты:
    - brand: марка транспорта
    - _engine_power: мощность двигателя
    - year: год выпуска
    - color: цвет транспорта
    - max_speed: максимальная скорость

    Свойства:
    - info: возвращает информацию о транспорте
    """
...
class Bus(PublicTransport):
    ...
    Свойства:
    - park: получает и устанавливает номер парка автобуса
    """
...
class Tram(PublicTransport):
    """
    Класс Tram представляет трамвай.
    ...
    Свойства:
    - how_long: вычисляет время прохождения маршрута
    """
